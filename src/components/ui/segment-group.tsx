      ...
      >
        ...
        {options.map((option) => (
          <SegmentGroup.Item
            key={option}
            value={option}
            className="flex flex-1 items-center justify-center text-center select-none cursor-pointer text-sm font-semibold px-4 py-3.5 z-20 text-slate-500 hover:text-slate-700 data-[state=checked]:text-orange-500 data-disabled:cursor-not-allowed data-disabled:opacity-40 transition-all duration-300"
          >
