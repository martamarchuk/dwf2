...
sections: [
  ...
  { type: 'paragraph', content: 'Customers ask before they buy – through Instagram DMs, WhatsApp, or website chat – and those messages never stop' },
  { type: 'paragraph', content: 'At first, it feels exciting. Then it becomes exhausting' },
  ...
  { type: 'heading', content: '2. Why Traditional Solutions Don\'t Work' },
  {
    ...
    content: 'You can\'t scale human attention<br /><br />Hiring more people can fix the bottleneck, but it brings extra costs, which can sometimes be significant for a Shopify store, and it takes time to teach new hires how to approach clients',
  ...
  { type: 'paragraph', content: 'An AI Sales Agent is your permanent team member – a digital salesperson trained to sell exactly like you would' },
  { type: 'paragraph', content: 'It understands customer intent, explains products, answers questions, recommends options, creates orders, sends payment links, and follows up until the deal closes' },
  { type: 'paragraph', content: 'Think of it as your Best Operator, Sales Representative, and Deal Closer combined into one' },
  { type: 'paragraph', content: 'Except this one never takes a day off' },

  { type: 'heading', content: '4. How It Works Behind the Scenes' },
  { type: 'paragraph', content: 'The brain behind the conversation' },
  { type: 'paragraph', content: 'Your AI Sales Agent is programmed based on your real data – past customer chats, tone of voice, product catalog, and Shopify integrations' },
  { type: 'paragraph', content: 'It detects language automatically, adapts tone to match your brand personality, and connects directly to your CRM and Shopify store' },
  { type: 'paragraph', content: 'When it talks, it’s not improvising – it’s acting on structured data and established logic built around how your customers buy' },

  { type: 'heading', content: '5. Key Features That Replace Human Labor' },
  { type: 'paragraph', content: 'Every step of your sales cycle, handled automatically' },
  { type: 'paragraph', content: 'Instant Multilingual Replies – answers customers in their own language within seconds\nProduct Consultation – helps them pick the right product or variation\nOrder Creation in Shopify – builds complete orders directly in your store\nCheckout Link Generation – sends payment links instantly in chat and by email\nCRM Integration – tracks every lead through the buying journey\nSKU-Aware Fulfillment – ensures the fulfillment team receives accurate SKU data\nAutomated Follow-Ups – reminds, re-engages, and closes deals that would otherwise be lost\nDaily Reports – sends you a single message showing how your AI Sales Agent performed today' },

  { type: 'heading', content: '6. Where It Lives' },
  { type: 'paragraph', content: 'Meet customers where they already buy' },
  { type: 'paragraph', content: 'Your AI Sales Agent works inside the same channels where customers message you now:' },
  { type: 'paragraph', content: 'Instagram DMs\nWhatsApp (normal account)\nWhatsApp Business Account (WhatsApp Cloud)\nTelegram bot\nTelegram account\nTikTok DMs\nFacebook Messenger\nViber\nWeChat\nLinkedIn\nSlack DMs\nWebsite chat' },
  { type: 'paragraph', content: 'We also support region-specific integrations where available' },
  { type: 'paragraph', content: 'No need to redirect anyone or change habits – the AI simply joins the conversation already happening' },

  { type: 'heading', content: '7. Human-in-the-Loop Mode' },
  { type: 'paragraph', content: 'Full control during launch and for special clients' },
  { type: 'paragraph', content: 'During early deployment, the system can operate in Human-in-the-Loop mode' },
  { type: 'paragraph', content: 'Every AI response appears for your review before sending – so you can approve or edit every message' },
  { type: 'paragraph', content: 'You can also enable this mode anytime:\n– when you want to interact with clients personally\n– for VIP customers who need personal attention\n– or simply when you feel like being in the loop' },
  { type: 'paragraph', content: 'This gives you confidence that everything the AI tells your clients sounds almost exactly like the way you would answer them yourself' },

  { type: 'heading', content: '8. You’re in Full Control' },
  { type: 'paragraph', content: 'Transparency and safety are built in' },
  { type: 'paragraph', content: 'Every message and event is logged' },
  { type: 'paragraph', content: 'The AI flags uncertain or sensitive moments and passes them for your review' },
  { type: 'paragraph', content: 'Any customer can be switched to “manual only” mode' },
  { type: 'paragraph', content: 'You get instant notifications if something unusual happens' },
  { type: 'paragraph', content: 'This isn’t blind automation – it’s automation with automated supervision' },
  { type: 'paragraph', content: 'You also get daily reports on what happened that day' },

  { type: 'heading', content: '9. Deep Integration with CRM' },
  { type: 'paragraph', content: 'Seeing your business at a glance' },
  { type: 'paragraph', content: 'All communication channels connect through the CRM' },
  { type: 'paragraph', content: 'Each conversation automatically becomes a lead and moves through the pipeline that mirrors your real sales stages' },
  { type: 'paragraph', content: 'With one look, you know how many new leads came in, which are ready to pay, and which need follow-ups' },
  { type: 'paragraph', content: 'From chaos to clarity' },

  { type: 'heading', content: '10. Deep Integration with Your Shopify Store' },
  { type: 'paragraph', content: 'Your AI Sales Agent is built to work natively with your Shopify store' },
  { type: 'paragraph', content: 'We import your entire product catalog – all products, categories, and product variations – directly into the AI’s memory' },
  { type: 'paragraph', content: 'When consulting clients, the AI provides links to relevant products or categories, so customers can explore your website and purchase the traditional way if they prefer' },
  { type: 'paragraph', content: 'If a customer decides to buy directly in chat, the AI creates the order inside Shopify automatically' },
  { type: 'paragraph', content: 'A unique payment link, generated by Shopify, is sent both in the chat and by email' },
  { type: 'paragraph', content: 'Each order is created precisely – with SKU codes, correct quantities, and selected product variations' },
  { type: 'paragraph', content: 'This way, every sale – whether through your website or chat – flows through one ecosystem: your Shopify\nNo mismatched data, no manual input, no worries' },

  { type: 'heading', content: '11. The Impact on Store Owners' },
  { type: 'paragraph', content: 'Freedom from the inbox' },
  { type: 'paragraph', content: 'No missed messages\nNo manual follow-ups\nNo waiting for managers to reply\nNo manual translations if clients are using a different language' },
  { type: 'paragraph', content: 'Just a continuous, calm flow of conversations and conversions' },
  { type: 'paragraph', content: 'What used to feel like juggling dozens of chats now feels like watching a well-tuned machine hum' },
  { type: 'paragraph', content: 'And lower operating costs mean less pressure on the business – and on the owner' },

  { type: 'heading', content: '12. The Role of Current Operators' },
  { type: 'paragraph', content: 'AI doesn’t replace – it upgrades your team, let me explain' },
  { type: 'paragraph', content: 'We often get asked: “What happens to my existing operators and sales agents?”' },
  { type: 'paragraph', content: 'When you add AI to your communication flow, your business grows – and your human team grows with it' },
  { type: 'paragraph', content: 'Operators move to higher-level roles: supervising AI, analyzing data, or developing other areas of the business' },
  { type: 'paragraph', content: 'Repetitive messaging disappears, but human creativity stays where it matters most' },

  { type: 'heading', content: '13. Implementation Process' },
  { type: 'paragraph', content: 'Fast setup, zero risk' },
  { type: 'paragraph', content: 'You provide us with conversation history, FAQs, and tone-of-voice examples' },
  { type: 'paragraph', content: 'You grant us partner access to your Shopify store' },
  { type: 'paragraph', content: 'We connect your communication channels to the CRM' },
  { type: 'paragraph', content: 'We configure and tune your AI Sales Agent (2–3 weeks)' },
  { type: 'paragraph', content: 'You test it in a private Telegram group and share feedback' },
  { type: 'paragraph', content: 'We refine and launch it in Human-in-the-Loop mode' },
  { type: 'paragraph', content: 'Final polish based on real interactions before full autopilot' },
  { type: 'paragraph', content: 'And after launch, we continue providing support and maintenance, updating the system as your business evolves — covering new patterns of customer behavior that may appear over time' },
  { type: 'paragraph', content: 'Your AI Sales Agent stays sharp and relevant through continuous updates and fine-tuning from our team, ensuring it always reflects how your customers actually communicate' },

  { type: 'heading', content: '14. Pricing Philosophy' },
  { type: 'paragraph', content: 'ROI first, always' },
  { type: 'paragraph', content: 'The system costs less than one human operator per month' },
  { type: 'paragraph', content: 'Our rule is simple: if the AI employee can’t generate more value than a human operator in the same position, you shouldn’t deploy it to your business' },
  { type: 'paragraph', content: 'Every project starts with two goals – measurable ROI with premium communication quality' },
  { type: 'paragraph', content: 'For us as developers, every new client and every new technical challenge expands the boundaries of what’s possible. Each project raises the overall quality of the system, and we apply the best proven practices across all clients whenever it makes sense' },
  { type: 'paragraph', content: 'This is a custom-built solution for every store, but it stands on the foundation of other successful implementations' },
  { type: 'paragraph', content: 'That’s why we can keep the price accessible – lower than the average salary of a single operator or sales agent. While making it scalable to any communication volume and fully ready for business growth without the need to hire or train new staff' },

  { type: 'heading', content: '15. What If I Have a Seasonal Business?' },
  { type: 'paragraph', content: 'Flexibility for slow months' },
  { type: 'paragraph', content: 'If your business is seasonal or experiences unpredictable waves of demand, you’re not locked in' },
  { type: 'paragraph', content: 'During quiet periods, we can pause or reduce your monthly subscription while the AI continues to handle a smaller volume of conversations' },
  { type: 'paragraph', content: 'And when orders suddenly skyrocket again, your AI scales instantly — no reconfiguration needed' },
  { type: 'paragraph', content: 'Returning to our core pricing philosophy: your AI employee must generate ROI, not sit as an expense' },

  { type: 'heading', content: '16. Communication Quality' },
  { type: 'paragraph', content: 'When technology feels human' },
  { type: 'paragraph', content: 'We define communication quality success not by how advanced the AI is, but by how natural it feels' },
  { type: 'paragraph', content: 'Your customers should never sense, or even guess, that they’re speaking with an AI instead of a real operator.' },
  { type: 'paragraph', content: 'Our digital employees deliver:\n– instant replies that feel personal – but never so fast that customers suspect automation\n– warmth, care, and tone perfectly aligned with your brand\n– responses in any language, making clients believe you have a large, multilingual team of skilled operators and sales agents\n– fast, flawless order creation and checkout links' },
  { type: 'paragraph', content: 'The result feels like having a full team working around the clock' },

  { type: 'heading', content: '17. Proof From Real Stores' },
  { type: 'paragraph', content: 'Already proven in live environments many times' },
  { type: 'paragraph', content: 'Our AI Sales Agents are already running in real Shopify stores, handling hundreds of daily messages, creating orders, and recovering lost revenue' },
  { type: 'paragraph', content: 'Read how one founder at MoldyFun scaled from 500 DMs per day to full automation\n→ [Read the Case Study]' },

  { type: 'heading', content: '18. How to Get Started' },
  { type: 'paragraph', content: 'Let’s see if your Shopify business is ready' },
  { type: 'paragraph', content: 'Send your Shopify link and list of communication channels' },
  { type: 'paragraph', content: 'We review your flow and tell you honestly if AI can bring ROI' },
  { type: 'paragraph', content: 'If it’s a fit, we build and launch your AI Sales Agent for you\n→ Book a Demo' },

  { type: 'heading', content: '19. From Manual Chaos to Autonomous Sales' },
  { type: 'paragraph', content: 'You no longer manage messages – you manage outcomes' },
  { type: 'paragraph', content: 'What once demanded constant attention now runs quietly, efficiently, and beautifully' },
  { type: 'paragraph', content: 'Your business keeps selling' },
  { type: 'paragraph', content: 'Your clients keep receiving care' },
  { type: 'paragraph', content: 'And you finally get to focus on growth, not chat windows' },
  { type: 'paragraph', content: 'Are you ready to see how this AI employee can change your everyday life?' },
]
