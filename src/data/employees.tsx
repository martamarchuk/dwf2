...
export const EMPLOYEES: EmployeeData[] = [
  ...
  sections: [
    ...
    { type: 'feature-highlight', content: 'Private Telegram staging environment for realistic testing' },
    ...
    { type: 'feature-highlight', content: 'Direct order creation inside Shopify' },
    ...
    { type: 'feature-highlight', content: 'Instant payment link generation (chat + email)' },
    ...
    { type: 'feature-highlight', content: 'Dynamic SKU-based product database' },
    ...
    { type: 'feature-highlight', content: 'Automated daily Telegram performance summary' },
    ...
    { type: 'feature-highlight', content: 'Stage-based smart follow-ups' },

    { type: 'heading', content: '12. The New Reality' },
    { type: 'paragraph', content: 'When the founder stops being the bottleneck – and becomes the owner again' },
    { type: 'paragraph', content: 'With every piece in place, a new rhythm settled into the business. The founder was no longer glued to his phone, no longer measuring days by unread DMs or missed opportunities.' },
    { type: 'paragraph', content: 'The assistant now does what once demanded his constant presence: it greets customers, answers questions with warmth, recommends products, creates orders, sends checkout links, follows up, and reports results – all without waiting for him to wake up, finish dinner, or “find a moment to reply.”' },
    { type: 'paragraph', content: 'What used to be a daily emotional load became a silent, reliable system working in the background. For the founder, the shift was more than operational – it was personal.' },
    { type: 'paragraph', content: 'He got his time back. He rediscovered the joy of running a business that grows without consuming him. And on our calls, we often catch a shared smile – a quiet acknowledgement of how far things have come.' },
    { type: 'paragraph', content: 'The business didn’t just scale. It became lighter to run.' },

    { type: 'heading', content: '13. For Shopify Store Owners' },
    { type: 'paragraph', content: 'If your sales happen in conversations, this is the only way to scale them' },
    { type: 'paragraph', content: 'If your customers message before they buy – on Instagram, WhatsApp, or web chat – you’re not just running a store. You’re running a conversation-driven sales business.' },
    { type: 'paragraph', content: 'And the truth is, it can only grow as far as you can reply.' },
    { type: 'paragraph', content: 'What we built here isn’t a chatbot. It’s a trained digital salesperson that speaks in your tone, answers with care, closes orders, sends checkout links, follows up, and recovers lost revenue – all without needing you to be online.' },
    { type: 'paragraph', content: 'It gives you back the two things most founders lose first: capacity and peace.' },
    { type: 'paragraph', content: 'If you’re curious whether this could work for your store, the next step is simple: we’ll show you how this system would look with your products, your tone, and your sales flow – so you can feel if the relief is worth it.' },
    { type: 'paragraph', content: 'No pressure. No push. Just a clear look at what scaling conversations can feel like when you’re no longer the bottleneck.' },
    { type: 'paragraph', content: 'If you’d like to explore it, send a message and we’ll walk you through it.' },
  ],
},
  },
  {
